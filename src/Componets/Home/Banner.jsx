...
const Banner = () => {
  return (
    <>
    <section className='bg-[url("/banner.png")]'>
      <div className='container m-auto pt-[153px] pb-[263px] flex flex-wrap justify-end'>
      <div className='bg-[#FFF3E3] w-fit pt-[62px] pl-10 pr-11 pb-9 rounded-[10px]'>
